...
public class Changeanim extends StateCtrlFunction {

	public Changeanim() {
		super("changeanim", new String[] {"value", "elem", "ignorehitpause", "persistent"});
	}
	...
	public Object getValue(String spriteId, Valueable... p) {
		...
		sprite.getSprAnimMng().setAction((int) fvalue);
