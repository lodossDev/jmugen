...
import org.lee.mugen.sprite.background.bgCtrlFunction.BgCtrlFunctionDef;
...
//			spriteInfo.addStateCtrl(stateCtrl);
	...
	public void process() {
		...
		ArrayList<BG> bgs = StateMachine.getInstance().getInstanceOfStage().getBgsMap().get(getCtrlid());
	...
	// /////////////:
	public static BGCtrlDef parseBGCtrlDef(String bGCtrlDefId, GroupText grp)
			throws Exception {

		BGCtrlDef bgCtrlDef = new BGCtrlDef(bGCtrlDefId);
