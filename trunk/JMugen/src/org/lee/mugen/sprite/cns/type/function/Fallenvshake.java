...
//	fall.EnvShake.freq = 70
    ...
    public Object getValue(String spriteId, Valueable... params) {
    	HitDefSub lastHitdef = StateMachine.getInstance().getSpriteInstance(spriteId).getInfo().getLastHitdef();
    	if (lastHitdef != null && lastHitdef.getFall().getEnvshake().getTime() > 0) {
    		StateMachine.getInstance().getInstanceOfStage().getCamera().setEnvShake(lastHitdef.getFall().getEnvshake());
    	}
