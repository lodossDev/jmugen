...
public class Projcontacttime extends SpriteCnsTriggerFunction {

	// TODO : to test projhittime and add like projhit
	public Projcontacttime() {
		super("projcontacttime", new String[] {});
	}
	@Override
	...
	public int parseValue(String[] tokens, int pos, List<Valueable> result) {
		...
		Matcher m = PROJ_CONTACT_TIME_SPEC_REG.matcher(keyStr);
	...
	public String getRegex() {
		return PROJ_CONTACT_TIME_SPEC_REG.pattern();
	}
}
