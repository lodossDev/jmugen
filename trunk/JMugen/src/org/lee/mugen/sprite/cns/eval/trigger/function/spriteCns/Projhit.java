...
public class Projhit extends SpriteCnsTriggerFunction {

	public Projhit() {
		super("projhit", new String[] {});
	}
	...
	public int parseValue(String[] tokens, int pos, List<Valueable> result) {
		...
		Matcher m = PROJ_HIT_SPEC_REG.matcher(keyStr);
...
//				} else 
	...
	public String getRegex() {
		return PROJ_HIT_SPEC_REG.pattern();
