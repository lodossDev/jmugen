	...
	public Object getValue(String spriteId, Valueable... params) {
		...
		for (Sprite s: StateMachine.getInstance().getSprites()) {
			...
			if (lastHitdef != null && !FightEngine.isBlockState(spriteHitted)
					...
					&& lastHitdef.getTimeCreated() + 1 < StateMachine.getInstance().getGameState().getGameTime()) {
					...
					&& lastHitdefOrigin.getTimeCreated() + 1 < StateMachine.getInstance().getGameState().getGameTime()) {
