...
public class Projguardedtime extends SpriteCnsTriggerFunction {

	// TODO : to test projhittime and add like projhit
	public Projguardedtime() {
		super("projguardedtime", new String[] {});
	}
	@Override
	 ...
	 */
	public static Pattern PROJ_GUARDED_TIME_SPEC_REG = Pattern.compile(
			"(" + "projguardedtime *\\((\\d+)\\)" + ")" +
			"|" +
			"\\b(" + "projguardedtime(\\d*)" + ")\\b", Pattern.CASE_INSENSITIVE);
	@Override
	...
	public String getRegex() {
		return PROJ_GUARDED_TIME_SPEC_REG.pattern();
	}
}
