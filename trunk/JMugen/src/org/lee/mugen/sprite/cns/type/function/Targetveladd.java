...
public class Targetveladd extends StateCtrlFunction {

    public Targetveladd() {
        super("targetveladd", new String[] {"x", "y", "id"});
    }
    ...
    public Object getValue(String spriteId, Valueable... params) {
		...
		if (valueableParams[xIndex] != null) {
			...
			targetSpr.getInfo().getVelset().setX(xValue);
		...
		if (valueableParams[yIndex] != null) {
			...
			targetSpr.getInfo().getVelset().setY(yValue);
